...
const allProject = [
  {
    ...
    img: "/images/projects/charma.png",
    links: [
      {
        to: "https://gifting-web.vercel.app/",
        icon: AiFillEye,
      },
      {
  ...
  },
  {
    ...
    img: "/images/projects/elite-residence.png",
    links: [
      {
        to: "https://eliteresidence.vercel.app/",
        icon: AiFillEye,
      },
      {
  ...
  },
  {
    ...
    description:
      "Pomofocus is website which help people track time for productivity and quality.",
    technologies: ["Next", "Framer", "Typescript", "Tailwind"],
    img: "/images/projects/pomofocus.png",
    links: [
      {
...
export default function Projects() {
  return (
    <section className="py-16" id="projects">
      <div className="flex flex-col items-start justify-center w-[80%] xl:w-[70%] gap-y-8 def-container">
          ...
          {allProject.map((project, index) => (
            ...
            >
              <div className="flex flex-col items-center basis-3/5">
                <div className="relative group w-[100%] sm:w-[90%] xl:w-[400px]  ">
                  <Image
                    src={project.img}
                    alt={project.title}
                    width={1900}
              ...
              <div className="flex flex-col items-center px-2 gap-y-4 basis-2/5">
                ...
                <p className="text-center max-w-[500px]">{project.description}</p>
                <div className="grid w-full grid-cols-1 gap-2 sm:grid-cols-2 lg:gap-6 ">
