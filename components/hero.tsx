    ...
    <section>
      <div className="h-screen flex flex-col items-start justify-center w-[80%] lg:w-[60%] gap-y-8 def-container header-height">
        <motion.h3
          ...
          animate={{ y: 0, opacity: 100, transition: {delay: 2} }}
        ...
        <motion.div
          initial={{ y: -100, opacity:0 }}
          animate={{ y: 0, opacity: 100,transition: {delay: 2.3} }}
        ...
        <motion.p
          initial={{ y: -100, opacity:0 }}
          animate={{ y: 0, opacity: 100,transition: {delay: 2.6} }}
        ...
        <motion.div initial={{ y: -100, opacity:0 }} animate={{ y: 0, opacity: 100,transition: {delay: 2.9} }}>
